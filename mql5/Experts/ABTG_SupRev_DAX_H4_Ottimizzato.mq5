...
#property description "SupertrendReversal OTT - DAX (D30EUR) H4 - PF 1.96 real-tick"
#property strict
...
input string InpComment   = "STREV DAX H4";
input long   InpMagic     = 970912;
...
void Enter(bool isLong,double stLine)
  {
   ...
   if(!ABTG_GuardiaIngresso(InpUsaGuardian,"ABTG_SupRev_DAX_H4_Ottimizzato")) return;
