...
#property description "SuperWave OTT - DAX (D30EUR) H4 - PF 1.28 real-tick"
#property strict
...
input ENUM_TIMEFRAMES InpTF   = PERIOD_H4;  // OTT SuperWave real-tick
input double InpStMult        = 3.0;        // OTT SuperWave real-tick
...
input double InpTP_RR         = 2.0;    // OTT SuperWave real-tick
...
input string InpComment   = "SUPERWAVE DAX H4";
input long   InpMagic     = 770512;
