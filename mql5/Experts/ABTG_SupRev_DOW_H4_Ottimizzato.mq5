...
#property description "SupRev OTT - Dow (U30USD) H4 - PF 2.77 real-tick"
#property strict
...
input int    InpStAtrPeriod   = 8;          // OTT indici real-tick
...
input string InpComment   = "STREV DOW H4";
input long   InpMagic     = 970914;
...
void Enter(bool isLong,double stLine)
  {
   ...
   if(!ABTG_GuardiaIngresso(InpUsaGuardian,"ABTG_SupRev_DOW_H4_Ottimizzato")) return;
