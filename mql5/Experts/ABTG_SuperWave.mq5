...
#property description "SuperWave - incrocio EMA14 x EMA200 a favore del Supertrend (dalla dashboard SuperWave)"
#property strict
...
input string InpComment   = "SUPERWAVE";
...
void Enter(bool isLong,double stLine)
  {
   ...
   if(!ABTG_GuardiaIngresso(InpUsaGuardian,"ABTG_SuperWave")){ cO_guardian++; return; }
