...
#property description "SupertrendReversal OTT - Nasdaq (NASUSD) H1 - PF 1.57 DD 1.2 real-tick"
#property strict
...
input ENUM_TIMEFRAMES InpTF   = PERIOD_H1;  // OTT indici
input double InpStMult        = 3.0;        // OTT indici real-tick
input int    InpStAtrPeriod   = 10;          // OTT indici real-tick
...
input double InpTP_RR         = 3.0;    // OTT indici real-tick
...
input group "=== Rischio ==="
input double InpRiskPercent   = 1.0;    // OTT indici: rischio 1% (DD basso)
...
input string InpComment   = "STREV NAS H1";
input long   InpMagic     = 970913;
...
void Enter(bool isLong,double stLine)
  {
   ...
   if(!ABTG_GuardiaIngresso(InpUsaGuardian,"ABTG_SupRev_NAS_H1_Ottimizzato")) return;
