...
#property description "SupertrendReversal OTT - DAX (D30EUR) H1 - PF 1.45 real-tick"
#property strict
...
input double InpStMult        = 3.5;        // OTT indici real-tick
...
input string InpComment   = "STREV DAX H1";
input long   InpMagic     = 970911;
...
void Enter(bool isLong,double stLine)
  {
   ...
   if(!ABTG_GuardiaIngresso(InpUsaGuardian,"ABTG_SupRev_DAX_H1_Ottimizzato")) return;
