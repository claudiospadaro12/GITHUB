...
5b. **ORB sull'apertura di LONDRA** (LiteFinance): forex/oro sull'apertura
   ...
   -> ❌ **CHIUSO R45 (14/08 notte): BOCCIATO 48/48** — zero celle verdi
   su oro e forex, Londra non salva niente (oro il meno peggio, GBPUSD il
   peggiore). **LA FAMIGLIA ORB CHIUDE SU OGNI SESSIONE MISURATA e la
   FASCIA C E' ESAURITA** (le voci restanti erano condizionate a un motore
   base vivo, che non esiste). Eredita': sedia 5 + lezione del retest.
   `REFERTO_ROUND45_LONDRA.md`
