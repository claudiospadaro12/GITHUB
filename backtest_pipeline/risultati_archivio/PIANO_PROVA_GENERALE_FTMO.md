...
| **X16** 🆕 | 🔴 **GAP TRADING — definizione ufficiale arrivata, ma non è chiaro se vale anche in Evaluation** | 🥇 **RISPOSTA SCRITTA FTMO 28/08**: *"Gap trading... aprendo trade simulati quando eventi macro/notizie potrebbero impattare il mercato, OPPURE entro 2 ore o meno prima che un mercato rilevante chiuda per almeno 2 ore"*. La frase **non è qualificata** "solo su conto finanziato" come invece lo erano news/overnight/weekend nella risposta FAQ del 27-28/08 | 🥇 testuale, formulazione universale | 🔴 **APERTO E POTENZIALMENTE CRITICO**: se si applica ANCHE durante il Free Trial (non solo da funded), allora **aprire una posizione il venerdì pomeriggio prima del weekend, o poco prima di una chiusura festiva, sarebbe una Forbidden Trading Practice fin da SUBITO** — diverso dal semplice "tenere aperto" (quello è libero in Evaluation). Va chiesto ESPLICITAMENTE al supporto se il divieto vale in Evaluation o solo da funded, prima del deploy di lunedì |
