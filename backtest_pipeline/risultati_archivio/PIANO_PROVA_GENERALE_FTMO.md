...
|---|---|---|---|---|
| **X1** | 🔴 **il trial simula SWING o NORMAL?** | il preset Guardian firmato vale **solo per il 2-Step statico** (⛔ *"su 1-Step questo preset è NULLO"*); l'aritmetica del margine vale **solo per Swing**. Nessuno dei due è verificato sul trial | 🔴 [INCERTO] contro 🟡 | ✅ **CHIUSO 27-28/08**: sonda 4/4 simboli conferma `ACCOUNT_LEVERAGE;100` (Standard) + ricerca sul sito conferma **"durante l'Evaluation Process, la restrizione overnight/weekend/news NON si applica indipendentemente dal tipo di conto"** — Standard va benissimo per il Free Trial e la challenge, **zero vincoli**. I vincoli (news/weekend/pausa>2h) si accendono **solo sul conto FINANZIATO** — vedi X14 |
| **X14** 🆕 | ⚠️ **Standard vs Swing SUL CONTO FINANZIATO (non sul trial)** | ricerca 28/08: Standard su funded impone news ±2min + weekend flat + flat se pausa mercato >2h; Swing toglie tutti e 3 **allo stesso prezzo** — ma la leva **CORRETTA da 🥇 RISPOSTA SCRITTA FTMO 28/08 è 1:15** sui 4 simboli (US30/GER40/US100/XAUUSD), **non 1:30** come da ricerca via search — E il conto Swing **da 200k NON ESISTE**, solo il **100k** | 🥇 **RISPOSTA SCRITTA** batte 🟡 [LETTO-VIA-SEARCH] | **APERTO, ma NON urgente**: decisione rinviabile a quando/se si passa al conto finanziato. Con leva reale 1:15 (metà di quanto si pensava) il margine su Swing è **ancora più stretto** — le sonde di stasera (fatte a leva 100) andrebbero rifatte da zero, e la taglia massima disponibile su Swing è **100k, non 200k** |
| **X15** 🆕 | 🔴 **concentrazione di rischio su simbolo/simboli CORRELATI — vietata da FTMO, non coperta dal Guardian** | Forbidden Trading Practice ufficiale: *"cumulative exposure in a specific symbol or correlated symbols"*; il cap C1 (3,25%) limita solo il TOTALE, non la concentrazione per simbolo/gruppo | 🥇 clausola vietata, non raccomandazione | 🔴 **APERTO E ATTIVO GIÀ SUL FREE TRIAL** (non solo a funded) — l'unico buco che morde SUBITO con 35 EA su un conto. Proposta P2 (cap per simbolo + per gruppo correlato): decide Claudio, 4-6h di sviluppo se approvato |
| **X16** | 🔴 **GAP TRADING — vale ANCHE in Evaluation, a differenza di news/weekend** | 🥇 **RISPOSTA SCRITTA FTMO 28/08 (Romeo Pagani, quarta mail del thread)**: *"It is very simple. If your strategy is gap trading, it is also not allowed in the Evaluation. [...] news trading and holding over the weekend are allowed during the Evaluation; gap trading is different [...]"*. Definizione tecnica (risposta precedente, Nicolas Novak): *"aprendo trade quando eventi macro/notizie potrebbero impattare il mercato, OPPURE entro 2 ore o meno prima che un mercato rilevante chiuda per almeno 2 ore"* | 🥇 risposta scritta, esplicita, diretta | ✅ **CHIUSO 28/08 — risposta netta ottenuta al 3° giro.** Il gap trading (nel senso FTMO: aprire posizioni a ridosso di news macro o nelle 2h prima di una chiusura di mercato ≥2h) **è vietato SEMPRE, anche in Evaluation** — è l'UNICA delle pratiche vietate che non ha l'eccezione Evaluation-vs-funded. **Conseguenza pratica da verificare**: quali EA della flotta aprono trade senza filtro news attivo (`InpUseNewsFilter` è spesso `false` di default, es. GoldenCross) o senza un cutoff prima della chiusura di sessione — è lo stesso tipo di buco già segnalato in X15, ma attivo da SUBITO, non solo a conto finanziato. **Non ancora auditata sistematicamente sulla flotta: proposta a Claudio.** |
...
| 4 | ✅ **risposta scritta FTMO su gap trading + one-sided bets** — RICEVUTA 28/08 | **supporto FTMO** (Nicolas Novak) | Gap trading definito (vedi X16); leva Swing corretta a 1:15; 200k Swing non esiste, solo 100k; nessun cap generale su lotti (MT5 forex max 50); tetto $400k confermato. **Resta da chiedere**: se il divieto gap trading vale anche in Evaluation (X16) |
