...
| **X16** 🆕 | 🔴 **GAP TRADING — definizione ufficiale arrivata, ma non è chiaro se vale anche in Evaluation** | 🥇 **RISPOSTA SCRITTA FTMO 28/08**: *"Gap trading... aprendo trade simulati quando eventi macro/notizie potrebbero impattare il mercato, OPPURE entro 2 ore o meno prima che un mercato rilevante chiuda per almeno 2 ore"*. La frase **non è qualificata** "solo su conto finanziato" come invece lo erano news/overnight/weekend nella risposta FAQ del 27-28/08 | 🥇 testuale, formulazione universale | 🟡 **TERZO GIRO INVIATO 28/08** — dopo due risposte (Nicolas Novak 27/08 tecnica ma senza scope, Romeo Pagani 28/08 vaga) che non chiudevano la domanda, la terza mail la riduce a **un sì/no netto**: *vale in Evaluation, o solo su conto finanziato come news/overnight/weekend?* (testo in `MAIL_FTMO_GAP_TRADING_TERZO_GIRO_2026-08-28.md`) — **in attesa di risposta scritta**. Nessun deploy che dipenda da questo punto finché non arriva |
