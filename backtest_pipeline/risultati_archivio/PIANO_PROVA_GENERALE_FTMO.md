...
| **X16** 🆕 | 🔴 **GAP TRADING — definizione ufficiale arrivata, ma non è chiaro se vale anche in Evaluation** | 🥇 **RISPOSTA SCRITTA FTMO 28/08**: *"Gap trading... aprendo trade simulati quando eventi macro/notizie potrebbero impattare il mercato, OPPURE entro 2 ore o meno prima che un mercato rilevante chiuda per almeno 2 ore"*. La frase **non è qualificata** "solo su conto finanziato" come invece lo erano news/overnight/weekend nella risposta FAQ del 27-28/08 | 🥇 testuale, formulazione universale | 🟡 **DOMANDA DI FOLLOW-UP INVIATA 28/08** (3 punti: se vale in Evaluation, se è "aprire" o anche "tenere", se vale sulle pause brevi o solo su chiusure ≥2h) — **in attesa di risposta scritta**. Nessun deploy che dipenda da questo punto finché non arriva |
