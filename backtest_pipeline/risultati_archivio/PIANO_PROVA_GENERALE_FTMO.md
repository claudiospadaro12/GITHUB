...
| **X14** 🆕 | ⚠️ **Standard vs Swing SUL CONTO FINANZIATO (non sul trial)** | ricerca 28/08: Standard su funded impone news ±2min + weekend flat + flat se pausa mercato >2h; Swing toglie tutti e 3 **allo stesso prezzo** ma leva 1:30 | 🟡 [LETTO-VIA-SEARCH], 4 pagine ufficiali concordi | **APERTO, ma NON urgente**: decisione rinviabile a quando/se si passa al conto finanziato. Se si sceglie Swing, le sonde margine di stasera (fatte a leva 100) vanno rifatte da zero — proposta P6 del dossier ricerca |
