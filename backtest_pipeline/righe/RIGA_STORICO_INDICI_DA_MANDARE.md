...
righe di lancio** qui sotto sta scritto come `PIN_QUI`. Dopo il commit+push si
...
(Get-Content backtest_pipeline\righe\RIGA_STORICO_INDICI_DA_MANDARE.md -Raw).Replace('PIN_QUI',$sha) |
