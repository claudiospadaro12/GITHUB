...
|---|---|---|
| `backtest_pipeline/righe/RIGA_POSTNEWS_ISM.ps1` | `f472982a41953c6ac22b507591ba8a6450294f6e8438bcba1d027a96946f61fc` | marcatore `MARCATORE_RIGA_POSTNEWS_ISM_v1` presente, **ASCII puro**, parse `pwsh` OK |
...
& { $ErrorActionPreference='Stop'; [Net.ServicePointManager]::SecurityProtocol=[Net.SecurityProtocolType]::Tls12;
    ...
    $pin='e994ca1fec86352874c7cd5b9558b6f770d2a48d'; $t0=Get-Date; $p="$env:USERPROFILE\RIGA_POSTNEWS_ISM.ps1"; Remove-Item $p -Force -EA SilentlyContinue;
