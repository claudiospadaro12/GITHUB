...
|---|---|---|
| `backtest_pipeline/righe/RIGA_POSTNEWS_ISM.ps1` | `2fe9724c64bb5b11cc1936aeb8cbea601157d530dd2afb355f1a16aab4bc098b` | marcatore `MARCATORE_RIGA_POSTNEWS_ISM_v1` presente, **ASCII puro**, parse `pwsh` OK |
...
& { $ErrorActionPreference='Stop'; [Net.ServicePointManager]::SecurityProtocol=[Net.SecurityProtocolType]::Tls12;
    ...
    $pin='a4e1d90161634d14d0a77b0754fec76fb5ef1c69'; $t0=Get-Date; $p="$env:USERPROFILE\RIGA_POSTNEWS_ISM.ps1"; Remove-Item $p -Force -EA SilentlyContinue;
