...
**22/09/2026** · branch `lavoro` · pin della riga: **`b7356cdd185ad53acf39cb2e4d6a38c138f847c9`**
...
| **rischio** | 🔴 **in IS il DD PUÒ SALIRE, ed è la prima cosa da guardare**: B2.2 (nel file prova, `grep "il cancello che potrebbe scattare"`) ha misurato che questo asse porta il DD IS da 5,52% a 7,76% in media e **fino a 12,4677%** sulla cella più alta. Misura a **denominatore fisso** `(Profit/RF)/80000×100`, e **due soglie, una per gamba** (classe 557): **IS** viva 5,7575 → allarme sopra **6,3333** · **OOS** viva 4,4499 → allarme sopra **4,8949** |
