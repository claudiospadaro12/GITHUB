...
#      I criteri stanno in prove\PREOPEN_RETEST_DOW_M15.txt, sezioni
...
#      La pagina da leggere PRIMA e' righe\RIGA_PREOPEN_DOW_DA_MANDARE.md
#
# ---------------------------------------------------------------------
...
#     (770202) e' nella lista dei VIETATI: se comparisse in un file
#     prova il round si ferma prima di aprire MT5.
...
#     U30USD dal 2024.09.26 sono agli atti (sonda del 17/08, COMPLETO).
...
#
#  LA RIGA CHE SI INCOLLA sta in righe\RIGA_PREOPEN_DOW_DA_MANDARE.md
# =====================================================================
[CmdletBinding()]
param(
...
$Work   = Join-Path $env:USERPROFILE "abtg_preopen_dow"
...
$PuntoIndice = 1.0     # 1 punto indice = 1,00 di PREZZO su U30USD.
                       #  MISURATO: cifre=2, tick=0.10 -> 1 punto indice =
                       #  100 punti MT5 (R97/R98, README_ABTG_Aperture riga
                       #  141). Su un indice il "pip" NON ESISTE.
...
$MagicVietati = @(770202,                                  # <<< LA SEDIA VIVA
                  770101,770201,770411,770511,770601,770611,770901,
                  971501,770402,970901,970912,970913,770532,
                  773300,773301,                           # R101 metro Dow
                  773200,773201,773230,773231,
...
$LAVORI = @()
$LAVORI += (Lav "metro_long"   "PREOPEN_METRO_DOW_M15.txt"        "METRO"   "LONG"  "METRO 0c: livello ORB (RangeMode=0) su M15, lato LONG"  773700 773701 "1" "0" "0" @("InpRangeMode","InpPrevWindowMin"))
$LAVORI += (Lav "metro_short"  "PREOPEN_METRO_DOW_M15_SHORT.txt"  "METRO"   "SHORT" "METRO 0c: livello ORB (RangeMode=0) su M15, lato SHORT" 773800 773801 "0" "1" "0" @("InpRangeMode","InpPrevWindowMin","InpAllowLong","InpAllowShort"))
$LAVORI += (Lav "griglia_long" "PREOPEN_RETEST_DOW_M15.txt"       "GRIGLIA" "LONG"  "LA GRIGLIA: livello PRE-apertura, lato LONG"            773500 773501 "1" "0" "1" @())
$LAVORI += (Lav "griglia_short" "PREOPEN_RETEST_DOW_M15_SHORT.txt" "GRIGLIA" "SHORT" "LA GRIGLIA: livello PRE-apertura, lato SHORT"          773600 773601 "0" "1" "1" @("InpAllowLong","InpAllowShort"))
$ProvaCosto = "PREOPEN_COSTO_DOW_M15.txt"
$ProvaBase  = "PREOPEN_RETEST_DOW_M15.txt"
...
try{
  ...
  foreach($nf in @($ProvaBase,$ProvaCosto,"PREOPEN_RETEST_DOW_M15_SHORT.txt","PREOPEN_METRO_DOW_M15.txt","PREOPEN_METRO_DOW_M15_SHORT.txt")){
  ...
  foreach($nfM in @("PREOPEN_METRO_DOW_M15.txt","PREOPEN_METRO_DOW_M15_SHORT.txt")){
    $hM = $mappe[$nfM]
...
Titolo "RACCOLTA"
$Cart = Join-Path $Dsk ("PREOPEN_DOW_" + $Modo + "_" + $Stamp)
New-Item -ItemType Directory -Force -Path $Cart | Out-Null

ScriviRef "====================================================================="
ScriviRef (" PREOPEN DOW -- il livello PRE-APERTURA su " + $Simbolo + " " + $Periodo)
...
ScriviRef " NON stanno qui: stanno in prove\PREOPEN_RETEST_DOW_M15.txt, sezioni"
...
ScriviRef ""
ScriviRef 'COME SI RIPRENDE: si riparte dalla pagina righe/RIGA_PREOPEN_DOW_DA_MANDARE.md,'
ScriviRef 'NON da questa riga. Per rifare una fase sola: -SoloFase COSTO|METRO|GRIGLIA.'

$refPath = Join-Path $Cart "REFERTO_PREOPEN_DOW.txt"
...
Write-Host "FILE ATTESI NELLO ZIP: REFERTO_PREOPEN_DOW.txt + i 5 file prova + gli 8 CSV IS/OOS + gen_preopen_costo.ini + REPORT_COSTO.htm" -ForegroundColor Gray
