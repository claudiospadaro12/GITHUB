...
**21/09/2026** · branch `lavoro` · pin della riga: **`77a1fb8caedff5b149c3d487f4468d9065cafdd5`**
...
> 📌 **Nota d'archivio**: il **file prova** sta al pin `77a1fb8caedff5b149c3d487f4468d9065cafdd5`
...
> `89f222bf` → `4bc9aa97` → `018c1d95` → `20d168b2` → `a774bb3b` → **questa**. Il cancello ha risposto
> **FAIL su tutte e cinque le precedenti**: 1º giro la **scala** e una «conferma» che era in
