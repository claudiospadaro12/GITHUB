...
| 11 | **tetto sull'ampiezza** | ❌ lo **nega** (*«è un po' largo però … sono dentro il movimento giornaliero»*) | `InpMaxRangePct = 0.8` (scarta il giorno se il box > 0,8% del prezzo) | 🟠 **NOSTRO IN PIÙ.** ⚠️ **Contro-esempio: morde pochissimo.** Il box medio misurato è **0,28%** su U30USD, **0,35%** su NASUSD, **0,26%** su D30EUR (FASE A / `_Point=0,01`): il tetto allo 0,8% è **quasi un no-op** → sul punto 11 siamo **di fatto d'accordo con Paolo** |
...
|---|---|---|
| "box diverso da Paolo" | i minuti MT5 di `[14:30, 14:45)` contro *«14.30, 14.44»* | 🟢 **VINCE IL CONTRO-ESEMPIO**: stesso insieme di barre. **Non è una differenza** |
...
| "il nostro tetto sul range ci allontana da Paolo" | l'ampiezza **media** misurata contro la soglia 0,8% | 🟢 **VINCE IL CONTRO-ESEMPIO**: 0,26-0,35% contro 0,8% ⇒ **quasi no-op**. Su quel punto siamo **d'accordo** con lui |
