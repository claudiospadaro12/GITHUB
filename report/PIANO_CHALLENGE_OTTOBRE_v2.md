...
| 2 | `DAX_Apertura_EU` **770101** 🏛️ reale · 100k · piccolo | D30EUR M5 | ✅ **R83 RETEST**, cella = cella viva · **[MISURATO]** | 🔴 **CONFLITTO APERTO**: **6,89%** (10,60% @1%, n 311, R83) contro **4,3501%** OOS (R119) **alla stessa taglia** · due misure 🥇 | **0,97** [MIS] | ✅ **0,65% vere** · **[MISURATO]** | 🟡 **42,3x** alla mediana **ma 33,0x sulla GEOMETRIA VIVA** (n=2) e **26,6x al P95** · **[MISURATO]** → **FRAGILE, sotto il pavimento dove conta** | **311** — EA **senza** `InpTP1Pct` **verificato**, sono posizioni ✅ · 🟢 PIENO |
...
| con **R2** pieno (deposito + rischio + modello dichiarati) | **5** — 🔴 `770101` in conflitto, `970913`/`770511` senza deposito, `771531` con tre misure diverse |
...
| 🔴 **che passano TUTTI E CINQUE, oggi, con numeri misurati** | # **ZERO** |
...
| 🎯 **Attribuire il conflitto di DD di `770101`** (R83 6,89% vs R119 4,35%) | lettura dei due CSV | `770101` | chiude R2, **ma resta rotta su R5**: **33,0x sulla geometria VIVA** | **+0** |
...
| Il conflitto di DD di `770101` (6,89 vs 4,35) | **cacciatore-strategie** | *"R83 e R119 differiscono per finestra, split o trailing 410? Qual e' il DD della cella VIVA?"* |
