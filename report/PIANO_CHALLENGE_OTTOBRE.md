...
| 6 | `ABTG_SupRev_NAS_H1_Ott` **970913** ⭐ | NASUSD H1 | 🟠 `REGISTRO_TEST` §S5v (PF 1,57 · 8/8 combo) | ✅ **0,76%** (1,17% @1% · tick · **n 155 = MERITO PIENO**) | **0,34** | 🔴 **2,00×** — bug tranche `:261-263` | 🔴 il fix di **due righe** (scritto, non applicato) + ricompilazione + firma sulla taglia. E' **il piu' prop-friendly del parco** ed e' fermo su un bug |
| 7 | `ABTG_SuperWave_DOW_H1_Ott` **770511** | U30USD H1 | 🟠 `REGISTRO_TEST` (PF 1,52 · 9/9 combo) | ✅ **2,60%** (4,0% @1% · tick · **n 227 = MERITO PIENO**) | **0,50** | 🔴 **2,00×** — bug `:253-255` | 🔴 stesso fix del n.6 · deposito del round **NON DICHIARATO** (M-C5) |
