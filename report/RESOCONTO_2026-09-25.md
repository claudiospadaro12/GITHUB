...
- 🔴 **Correzione mia del pomeriggio**: il Guardian in campo e' **4,5 / 9,3 / 3,5 / cap 4,00**, non 4,9/9,9/4,0 come avevo scritto al mattino (fonte: `CODA_08` 25/09, `chart06.chr`). All'emergenza totale (72.560) mancano **2.530,72 EUR = due stop pieni a 2%**: il secondo di fila **ferma la challenge**, e il blocco non scade da solo.
