...
|---:|---|---|---|---|:---:|---|---|---|
| **1** | **ORB hedge-safe**: `PositionClose/Modify(_Symbol)` → **per TICKET** | `19312c8` | 03/09 | +554/−49 (cod **+322/−16**) | 🔴 **SÌ** | `ORB_Ottimizzato` U30USD M5 · **770611** · 0,3% | **100k 50504263** | l'EA **scrive sulla posizione del VICINO** (chiude, sposta lo SL). Vicino `Dow_Apertura_US` 770202 su U30USD **confermato**, conto **hedging**. ✏️ **MISURATO 13/09** (`report/ORB_DOW_100K_COMPRESENZA_2026-09-13.md`): su 29 operazioni reali del 100k (10/08-03/09), **1 sola sovrapposizione temporale su 24 coppie possibili** (13/08, 11 min), e in quel caso il ticket più basso era l'ORB stesso → **non ha morso**. Tutte le 11 posizioni U30USD chiuse a SL, nessuna chiusura anomala. **Rischio raro (~4% dei giorni), non quotidiano: retrocesso da emergenza a riparazione ordinaria** |
