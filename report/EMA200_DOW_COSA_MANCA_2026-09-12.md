...
| **4** | `COLLAUDO_EMADOW_03_uscita_TP1PCT.txt` | requisito 3 — e il rapporto deal/posizione (classe 226) | **10** | ~4 min | la gestione dell'uscita è il buco più grosso del certificato |
...
| **6** | `COLLAUDO_EMADOW_04_uscita_TRAILING.txt` | seconda metà del requisito 3 | **4** | ~2 min | completa la 4, costa poco |
