...
**30 parametri censiti: 2 congelati · 13 proposti · 15 aperti.**
Congelati: A1 (rischio 0,65%, 09/08) · F4 (niente acquisti prima del forward
maturo + risposte scritte, 13/08). Dei 15 aperti, i 5 marcati 🎬 hanno avuto la
risposta dell'analista-trascrizioni (**"niente di numerico"**: restano aperti,
ma ora si sa da dove NON arrivera' la chiusura) e 4 si chiudono con misure di
casa a costo zero dati (M1, M2 + E3, E4).
