...
| M11 | **CENSIMENTO DEI CONTRATTI delle sedie accese** (prerequisito dichiarato della FIRMA 2/C3): per ogni sedia, il **DD promesso** e le **operazioni/mese promesse**, presi dal referto che l'ha promossa. _"Senza tabella, la regola e' inchiostro"_ | ✅ **assegnato, IN CORSO** (lanciato 18/08 stesso, alla firma) | "tabella sedia → DD promesso → op/mese promesse → referto di provenienza" |
