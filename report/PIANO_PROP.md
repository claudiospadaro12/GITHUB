...
| M44 🆕 | 📥 **I CSV DEI 34 ROUND DELLA NOTTE 12/13-09 — riga K1.** I round sono girati sul **50504400** (`C:\MT5_Backtest`) e i dati **esistono**, ma il runner **pubblica solo il referto, mai i CSV** (**classe 307**): restano sul VPS, zippati per round sul Desktop. 🔴 **Finche' non arrivano nel repo, `R120b/e`, `R126a/b/d`, `R127b/c`, `R132c`, `R133b/c`, `R136a-d`, `R137a-c`, `R138a`, `R141a-d`, `R142a-c`, `cemad05`, `q770be` restano `[NON MISURATO]`** — e il tappo si e' spostato, non sciolto: da *"non girano"* a *"girano e nessuno legge"* | 👤 **Claudio** (`carica_risultati.ps1` dal VPS) · poi 🤖 agenti per la lettura | *"Lancia la raccolta sul VPS e mandami lo zip: sono ~34 round con CSV validi che aspettano solo di essere letti. Il piu' pesante e' `r126d` (4.693 s di macchina gia' spesi): buttarli sarebbe buttare una notte di lavoro."* 🟢 **Costo: zero macchina, e' solo un trasferimento** |
