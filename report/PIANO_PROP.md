...
| **L5** | ❌ **Tre bocciature col numero, per non dimenticarle**: `r138a` (F40EUR, DD OOS 11,82% > muro 10%) · `q770be` (breakeven non tocca la peggior giornata: −1,0793% su 4 celle su 4, +0,0000 pp) · `r139a/b/c` (EMA200/FiboH4 su AUDJPY/GBPUSD, DD 15-23% contro soglia 14%, r139b con segno che si INVERTE fra le 4 celle = regime, non edge) | ❌ **Non entrano**, e il perche' e' scritto coi numeri | 🥇 `report/LETTURA_BACKLOG_NOTTE_2026-09-13.md` tabella completa | ✅ chiuso (bocciature) |
