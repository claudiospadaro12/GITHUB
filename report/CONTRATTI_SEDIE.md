...
| EA | Simbolo | Magic | Rischio | DD promesso | Op/mese | Finestra | Fonte | Etichetta |
|---|---|---|---:|---|---|---|---|---|
| ABTG_DAX_Apertura_EU | D30EUR | 770101 | 1,0 (+0,65 sul 100k) | 🆕 **4,3501%** alla taglia viva **0,65%** · **6,7111%** a **1,0%** — **[MISURATO a deposito 10.000 EUR]**. ⚠️ **ASTERISCO DEL DEPOSITO**: a **100.000 EUR** il DD promesso e' **[NON MISURATO]** — la stessa cella long-only a 1,0% fa **7,2328%** su banco 100k contro **6,7111%** su banco 10k, **+7,8% a parita' esatta di 270 operazioni** (`aperture_r47/..._OOS_r47a.csv` r.2). 🔴 **ERRATA 11/09**: il ~~**10,60%** (R83, cella RETEST viva a 1%)~~ che stava qui **non e' di questa sedia**: la fonte citata ha `InpAllowShort=1`, `InpRiskPercent=1` e `InpMagic=777120/777121` — verificato colonna per colonna. Il lato corto da solo vale **+3,8873 punti** di DD (10,5984 con, 6,7111 senza, stessa finestra e stesso deposito). Cronologia del contratto: 6,25% (R16) -> 10,60% (R83, revisione firmata 02/09, `FIRME_2026-09-02.md`) -> **4,3501%** (R119, 11/09). | **~21** (270 uscite; ⚠️ in POSIZIONI sono **193** sulla gemella long-only `r47a` — chi ricalcola la frequenza usi 193) | OOS 2025.06.10->2026.06.30, 12,6 mesi, **UN SOLO REGIME (toro)** | 🥇 `ritardo_r119b_csv/ABTG_DAX_Apertura_EU_D30EUR_OOS_R119_DAX_D0000.csv` r.2 (`InpAllowShort=0` · `InpMagic=770101` · PF 1,41105 · n 270) e riproduzione indipendente `ancora_passo7/..._OOS_ANCORA.csv` r.2 · a 1,0%: `aperture_r35/..._OOS_r35.csv` r.8 · 📄 `report/CONFLITTO_DD_770101_2026-09-11.md` · storici: `REFERTO_PORTAFOGLIO_R16.md` · `REFERTO_ROUND46_GESTIONE.md` | ✅ [TROVATO] |
...
| ABTG_MaxMinNotte (oro notte) | XAUUSD | 770402 | **0,5** (ridotta da 1,0 il 23/08, firma REVISIONE R100) | **10,0%** (R100: DD 22 anni 19,72% a rischio 1% -> 10,0% a 0,5% [APPROSSIMATO lineare]; limite inferiore OHLC; ATTENZIONE: TORO 2021 da solo 9,4% a 1%) | **~3,7 posizioni** (dato R17; forward reale finora: 2 trade) | **2004.06.11→2026.06.30 (22 anni, R100)** | `risultati_archivio/R100_REFERTO.md` · zip `R100_ORO_FLOTTA_CORSA_20260823_1449` · storia: R17 | 🟢 [RISCRITTO da R100, firma 23/08] · prop: solo <= 0,5% |
...
| ABTG_EMA200_Ottimizzato | XAUUSD | 971501 | **0,25** (ridotta da 1,0 il 23/08, firma REVISIONE R100) | **11,5%** (R100: DD 22 anni 45,91% a rischio 1% -> 11,5% a 0,25% [APPROSSIMATO lineare]; limite inferiore OHLC; sforo 10,4x sul vecchio promesso) | **~6,6** (199 tr / 30 mesi, dato vecchio) | **2004.06.11→2026.06.30 (22 anni, R100)** | `risultati_archivio/R100_REFERTO.md` · zip `R100_ORO_FLOTTA_CORSA_20260823_1449` | 🟢 [RISCRITTO da R100, firma 23/08] · **prop: NO a nessuna taglia** |
