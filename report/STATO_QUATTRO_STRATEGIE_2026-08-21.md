...
| **BREAKOUT del corso** | 🟢 SI' `ABTG_BreakoutCorso.mq5` (nuovo, 18/08) | 🟢 si' (autotest PASSATO nel log) | ❌ no — EA da tester. ⚠️ **CORRETTO 21/08 sera**: `BREAKOUT_EA_JPY_v3` risulta **ANCORA PRESENTE** nei `.chr` in tutti e sette i censimenti (ultimo 19/08 15:34) — qui era data per spenta senza aprire il censimento. Claudio ha firmato lo spegnimento il 21/08 (*"A, SU JPY"*): esecuzione da fare, vedi `FIRMA_2026-08-21_DUE_SEDIE.md` | 🟢 **R82 — TORNEO JPY, CHIUSO 18/08 18:05** | **ZERO vincitori su 7 cross**. Miglior caso EURJPY IS +5.476/PF 1,112 → OOS −6.108/PF 0,902. 264-2.138 op/finestra | 🔴 **BOCCIATA con processo completo** (18/08). Sedia spenta con **FIRMA 5 di Claudio "SPEGNILE TUTTE E TRE"**, eseguita e verificata 09:41. Porta di rientro C3: **solo con una TESI NUOVA, non una taratura** | non blocca nulla: **capitolo chiuso**. Resta il collaudo `[BRK][AUTOTEST]` mai eseguito — igiene, non decisione |
...
**Forward:** ❌ no, e' un EA da tester. Predecessore `BREAKOUT_EA_JPY_v3` su USDJPY: ⚠️ **NON spenta** — correzione del 21/08 sera, il suo `.chr` c'e' in tutti e sette i censimenti (ultimo 19/08 15:34). Spegnimento firmato da Claudio il 21/08, da eseguire: `report/FIRMA_2026-08-21_DUE_SEDIE.md`.
