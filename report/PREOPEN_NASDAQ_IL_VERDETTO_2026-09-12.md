...
| 4 | **gemelli** | 🟠 **PARZIALE**, ma ✅ **CORRETTO IL 13/09 — e la correzione va a FAVORE del meccanismo.** Avevo scritto che il cancello di ampiezza *"era SPENTO sul gemello"*: vero per `ABTG_DAX_Live5m` (`MINRANGE 0`/`MAXRANGE 0`), 🔴 **ma una corsa COL CANCELLO ACCESO ESISTE GIA' IN ARCHIVIO e non l'avevo aperta**: `risultati_prove/ABTG_DAX_Live5m_v2/`, `MinRange 1500 / MaxRange 4000`, letto da me dai CSV grezzi: **IS PF 1,00564 · n 80 · DD 4,70%** e **OOS PF 0,92490 · n 202 · DD 14,16%**, @ rischio **1%**. 🟢 **E il cancello MORDE NEL VERSO GIUSTO**: a cancello spento la stessa famiglia fa OOS **0,857** su n 342 con DD **39,74%**. ⚠️ Confondimenti nominati, perche' le due corse non sono gemelle: **rischio 1% contro 2%**, slippage 100 pt, `CloseHour` 17:30. U30USD/SPXUSD restano mai provati. 👉 La voce 4 resta **parziale** — ma non per la ragione che avevo scritto |
